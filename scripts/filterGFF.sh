...
if [ -z "$species" ] || [ -z "$te_gff" ] ; then
    echo "Error:  -s and -g is necessary"
    usage
fi
...
if [ "$species" == "cattle" ]; then
    cp ${PARENT_DIR}/data/expTEsub_cattle ./
    ...
    cp ${PARENT_DIR}/data/expTEsub_chicken ./
    ...
    cp ${PARENT_DIR}/data/expTEsub_goat ./
    ...
    cp ${PARENT_DIR}/data/expTEsub_pig ./
    ...
    cp ${PARENT_DIR}/data/expTEsub_sheep ./
